...
public class PointDigit extends Picture implements Animated {
    public enum Value {
    ...
    public PointDigit(MainManager mainManager, Point2DFloat inSize) {
        super(mainManager, inSize, Orientation.NORMAL);
    }

    public PointDigit(MainManager mainManager, Point2DFloat inSize, RectF margins) {
    ...
    public void draw() {
        ...
        switch (value) {
            case NUMBER_0:
                glBindTexture(GL_TEXTURE_2D, mainManager.texturesId.point_counter_number_0);
                break;
            case NUMBER_1:
                glBindTexture(GL_TEXTURE_2D, mainManager.texturesId.point_counter_number_1);
                break;
            case NUMBER_2:
                glBindTexture(GL_TEXTURE_2D, mainManager.texturesId.point_counter_number_2);
                break;
            case NUMBER_3:
                glBindTexture(GL_TEXTURE_2D, mainManager.texturesId.point_counter_number_3);
                break;
            case NUMBER_4:
                glBindTexture(GL_TEXTURE_2D, mainManager.texturesId.point_counter_number_4);
                break;
            case NUMBER_5:
                glBindTexture(GL_TEXTURE_2D, mainManager.texturesId.point_counter_number_5);
                break;
            case NUMBER_6:
                glBindTexture(GL_TEXTURE_2D, mainManager.texturesId.point_counter_number_6);
                break;
            case NUMBER_7:
                glBindTexture(GL_TEXTURE_2D, mainManager.texturesId.point_counter_number_7);
                break;
            case NUMBER_8:
                glBindTexture(GL_TEXTURE_2D, mainManager.texturesId.point_counter_number_8);
                break;
            case NUMBER_9:
                glBindTexture(GL_TEXTURE_2D, mainManager.texturesId.point_counter_number_9);
                break;
            case DASH:
                glBindTexture(GL_TEXTURE_2D, mainManager.texturesId.point_counter_dash);
                break;
        }
