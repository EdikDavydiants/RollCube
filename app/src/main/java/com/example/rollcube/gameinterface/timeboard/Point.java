...
public class Point extends Picture implements Animated {


    public Point(MainManager mainManager, Point2DFloat inSize) {
    ...
    public void draw() {
        ...
        glBindTexture(GL_TEXTURE_2D, mainManager.texturesId.timer_point);
