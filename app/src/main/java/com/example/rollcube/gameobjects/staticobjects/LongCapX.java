...
public class LongCapX extends GameTextureObject {


    public LongCapX(MainManager mainManager, int n, int m) {
        super(mainManager);
        float dX = GameBoard.GAP_WIDTH + n * GameBoard.CELL_SIDE;
        float dZ = m * GameBoard.CELL_SIDE;
        float sideX = GameBoard.TILE_SIDE;
        float sideZ = GameBoard.GAP_WIDTH;
